...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-561666","is-html-561666","is-jsdelivr-561666","is-gtm-561666","is-gravatar-561666","is-theme-561666","is-json-561666"];
      return Promise.all(
        names
