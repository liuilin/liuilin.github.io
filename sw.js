...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f45bd7","is-html-f45bd7","is-jsdelivr-f45bd7","is-gtm-f45bd7","is-gravatar-f45bd7","is-theme-f45bd7","is-json-f45bd7"];
      return Promise.all(
        names
