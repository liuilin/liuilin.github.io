...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-12e0dd","is-html-12e0dd","is-jsdelivr-12e0dd","is-gtm-12e0dd","is-gravatar-12e0dd","is-theme-12e0dd","is-json-12e0dd"];
      return Promise.all(
        names
