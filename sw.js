...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-c671d3","is-html-c671d3","is-jsdelivr-c671d3","is-gtm-c671d3","is-gravatar-c671d3","is-theme-c671d3","is-json-c671d3"];
      return Promise.all(
        names
