...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-b28c05","is-html-b28c05","is-jsdelivr-b28c05","is-gtm-b28c05","is-gravatar-b28c05","is-theme-b28c05","is-json-b28c05"];
      return Promise.all(
        names
