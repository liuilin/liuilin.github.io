...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e6816c","is-html-e6816c","is-jsdelivr-e6816c","is-gtm-e6816c","is-gravatar-e6816c","is-theme-e6816c","is-json-e6816c"];
      return Promise.all(
        names
