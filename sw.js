...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-136ebd","is-html-136ebd","is-jsdelivr-136ebd","is-gtm-136ebd","is-gravatar-136ebd","is-theme-136ebd","is-json-136ebd"];
      return Promise.all(
        names
