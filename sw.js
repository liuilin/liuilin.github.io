...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-7951a3","is-html-7951a3","is-jsdelivr-7951a3","is-gtm-7951a3","is-gravatar-7951a3","is-theme-7951a3","is-json-7951a3"];
      return Promise.all(
        names
