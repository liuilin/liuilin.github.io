...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-394e6d","is-html-394e6d","is-jsdelivr-394e6d","is-gtm-394e6d","is-gravatar-394e6d","is-theme-394e6d","is-json-394e6d"];
      return Promise.all(
        names
