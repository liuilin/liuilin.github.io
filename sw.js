...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6131db","is-html-6131db","is-jsdelivr-6131db","is-gtm-6131db","is-gravatar-6131db","is-theme-6131db","is-json-6131db"];
      return Promise.all(
        names
