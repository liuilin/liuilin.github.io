...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-14760c","is-html-14760c","is-jsdelivr-14760c","is-gtm-14760c","is-gravatar-14760c","is-theme-14760c","is-json-14760c"];
      return Promise.all(
        names
