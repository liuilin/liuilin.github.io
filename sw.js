...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-1d8334","is-html-1d8334","is-jsdelivr-1d8334","is-gtm-1d8334","is-gravatar-1d8334","is-theme-1d8334","is-json-1d8334"];
      return Promise.all(
        names
