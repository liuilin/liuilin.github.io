...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-24b389","is-html-24b389","is-jsdelivr-24b389","is-gtm-24b389","is-gravatar-24b389","is-theme-24b389","is-json-24b389"];
      return Promise.all(
        names
