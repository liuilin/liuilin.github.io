...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-03ed71","is-html-03ed71","is-jsdelivr-03ed71","is-gtm-03ed71","is-gravatar-03ed71","is-theme-03ed71","is-json-03ed71"];
      return Promise.all(
        names
